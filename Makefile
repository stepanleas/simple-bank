...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/stepanleas/backend-master-class/db/sqlc Store
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/stepanleas/backend-master-class/worker TaskDistributor
